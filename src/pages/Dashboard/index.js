...
import ErrorDemoPage from '../Demo Loading Page'
                            ...
                            <nav className="mt-6">
                                <div>
                                    ...
                                    >
                                        ...
                                        <button className="mx-4 text-sm font-normal" id="fetch-product" onClick={(e) => fetchProducts(e.target.id)} >Product List</button>
                                    </a>
                                    <a
                                        className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
                                        href="#"
                                    >
                                        ...
                                        <button className="mx-4 text-sm font-normal" id="add-product" onClick={(e) => addProducts(e.target.id)} >Add a Product</button>
                                    </a>
                                    <a
                                        className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
                                        href="#"
                                    >
                                        ...
                                        <button className="mx-4 text-sm font-normal" id="inbox" onClick={(e) => inboxFunc(e.target.id)} >Inbox</button>
                                    </a>
                                    ...
                                    >
                                        ...
                                        <button className="mx-4 text-sm font-normal" id="inbox" onClick={() => logoutFunc()} >Sign out</button>
                                    </a>
                                </div>
                            </nav>
                        </div>
                                ...
                                <div className="relative flex items-center w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
                                    ...
                                    <div className="relative flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto">
                                        <a href="#" class="relative block">
                                            <label>Welcome {localStorage.getItem("username")}</label><br />
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col flex-wrap sm:flex-row ">
                                <div className="w-full">
                                    <div className="w-full bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                        {showProduct === "fetch-product" ? <p className="p-4 font-bold text-black text-md dark:text-white">
                                            Products
                                        </p> :
                                            showProduct === "add-product" ? <p className="p-4 font-bold text-black text-md dark:text-white">
                                        ...
                                        {showProduct === "fetch-product" ? <ProductCard /> :
                                            showProduct === "add-product" ? <RegisterProduct /> : <ErrorDemoPage />}
